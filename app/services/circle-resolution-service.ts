...
import {
  ...
  normalizeCircleName,
} from "~/services/circle-registry-service";
import type { Circle } from "~/types/circle";
import type { CircleResolution } from "~/types/circle-registry";
...
// circles（app/data/circles.ts）とcircle_registry（app/data/circle-registry.ts）の
