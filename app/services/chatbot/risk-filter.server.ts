import { RISK_C_KEYWORDS } from "~/data/chatbot/risk-c-keywords";
...
// C層トピックをキーワード照合でブロックする（docs/decisions/0004-chatbot-architecture.md §4・§5）。
...
// C層に該当した場合に返す定型文（docs/decisions/0004-chatbot-architecture.md §4「LLMを呼ばず定型文」）。
