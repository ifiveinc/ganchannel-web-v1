...
この食い違いは hearing-points.md §1（決定後に削除。内容は本ADRに統合済み）に確認事項として記録し、代表への確認を行った。
...
**【2026-09-03更新】** 学祭（10/16）向け機能（[festival-issues.md](../project/festival-issues.md) Section A等）のルート・画面実装が本格化する前に移行を終えた方が手戻りが小さいため、チームで確認のうえ着手時期を前倒しした。移行作業は[festival-issues.md H-1](../project/festival-issues.md)で管理する（着手：2026-09-04、締切：2026-09-06）。「MVP公開後、落ち着いた段階で着手」という当初の想定は変更し、今回の前倒しをもって着手済みとする。
